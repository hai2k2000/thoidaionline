...
type Row = { id: string; name: string; department: string; total: number; done: number; returned: number; inProgress: number; waiting: number; overdue: number; attendanceRate: number | null; score: number | null; tasks: Task[] };

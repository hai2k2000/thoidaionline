...
type Row = { id: string; name: string; department: string; total: number; done: number; overdue: number; score: number | null; tasks: Task[] };
...
export default function PublicEvaluationSummary({ userLabel }: { userLabel: string }) {
  ...
  useEffect(() => {
    fetch("/api/public-evaluation-summary")

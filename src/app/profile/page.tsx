              ...
              {tasksAssignedToMe.map((t) => (
                <tr key={`mine-${t.id}`} className="cursor-pointer" onClick={() => router.push(`/tasks/${t.id}`)}>
                  <td className="px-2 py-2">
                    <span className="inline-flex items-center rounded bg-blue-50 px-2 py-1 font-semibold text-blue-700">{t.title}</span>
                  </td>
            ...
            <tbody>
              {myAssets.map((a) => (
                <tr key={a.id} className="cursor-pointer" onClick={() => router.push(`/assets/${a.asset_id}`)}>
                  <td className="px-2 py-2">
                    <span className="inline-flex items-center rounded bg-blue-50 px-2 py-1 font-semibold text-blue-700">{a.assets?.asset_name ?? "-"}</span>
                  </td>

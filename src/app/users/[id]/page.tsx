          ...
          <>
            ...
            <section className="mt-4 rounded-xl border bg-white p-4">
              ...
              <table className="min-w-full text-left text-sm">
                <thead className="bg-slate-50"><tr><th className="px-2 py-2">Task</th><th className="px-2 py-2">Trạng thái</th><th className="px-2 py-2">Tiến độ</th><th className="px-2 py-2">Hạn</th><th className="px-2 py-2">Chi tiết</th></tr></thead>
                <tbody>
                  {tasks.map((t) => (
                    <tr key={t.id} className="border-t">
                      ...
                      <td className="px-2 py-2"><Link href={`/tasks/${t.id}`} className="text-blue-600 underline">Mở</Link></td>
                    </tr>
                  ))}

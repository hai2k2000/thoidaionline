                ...
                <tbody>
                  {tasks.map((t) => (
                    <tr key={t.id}>
                      ...
                      <td className="px-2 py-2"><Link href={`/tasks/${t.id}`} className="inline-flex items-center rounded bg-red-50 px-2 py-1 text-xs font-semibold text-red-700 hover:bg-red-100">Mở</Link></td>
                    </tr>
                  ))}
